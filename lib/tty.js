...
Session.prototype.handleCreate = function(cols, rows, func) {
  ...
  if (self.connectionData != null)
  {
    ...
    if (fs.existsSync(configFile))
    {
      ...
      shell = "bundle exec bosh";
      shellArgs[0] = "-c" + configFile;
      shellArgs[1] = "-C" + cacheDir;
      shellArgs[2] = "-d" + self.connectionData.deployment;
      shellArgs[3] = "ssh";
      shellArgs[4] = self.connectionData.job;
      shellArgs[5] = self.connectionData.index;
    }
  }
